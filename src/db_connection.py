...
# acnh-analytics-pipeline/src/db_connection.py
#
...
def test_connection() -> None:
    ...
    This function is useful to verify that the .env file and the
    PostgreSQL database are configured correctly.
    """
...
#
# If the connection is correct, a success message is logged.
