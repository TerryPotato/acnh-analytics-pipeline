...
def run_transformations() -> None:
    ...
    The master procedure refreshes the harmonized base tables (fish,
    insects, fossils, villagers, housewares, recipes) and then the derived
    tables that depend on them (creatures_availability, creatures_hourly,
    villager_furniture, recipe_materials), in that order.
    """
